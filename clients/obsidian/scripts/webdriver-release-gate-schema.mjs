...
export function sanitizedGateFailure(code) {
  const allowed = new Set([
    ...
    "launch_failed", "webdriver_attach_failed", "result_not_rendered", "stale_notice_observed",
    "open_not_invoked", "open_promise_rejected", "cleanup_incomplete", "unexpected_failure",
  ]);
  return {
    schema_version: 1,
