...
export function sanitizedGateFailure(code) {
  const allowed = new Set([
    ...
    "launch_dependency_missing", "launch_shared_memory_unavailable", "launch_runtime_file_missing",
    "launch_session_bus_unavailable", "launch_subprocess_failed", "launch_display_unavailable", "launch_sandbox_unavailable",
    "launch_gpu_unavailable", "launch_instance_conflict", "launch_singleton_socket_path_failed",
    "launch_crash_reporter_unavailable",
    "launch_runtime_resources_unavailable", "launch_platform_runtime_failed",
    "launch_v8_bootstrap_failed", "launch_electron_bootstrap_failed", "launch_browser_bootstrap_failed",
    "launch_node_bootstrap_failed", "launch_process_model_failed", "launch_process_cpu_metrics_failed",
    "launch_process_memory_metrics_failed", "launch_process_metrics_failed", "launch_process_spawn_runtime_failed",
    "launch_process_handle_runtime_failed", "launch_process_enumeration_failed", "launch_process_scheduling_failed",
    "launch_process_identity_failed", "launch_process_platform_failed", "launch_thread_runtime_failed",
    "launch_sequence_runtime_failed", "launch_task_runtime_failed", "launch_run_loop_failed",
    "launch_blocking_runtime_failed", "launch_event_loop_failed",
    "launch_feature_initialization_failed", "launch_filesystem_unavailable", "launch_memory_unavailable",
    "launch_ipc_unavailable", "launch_argument_invalid", "launch_network_runtime_failed",
    "launch_proxy_runtime_failed", "launch_network_monitor_failed", "launch_socket_runtime_failed",
    "launch_devtools_server_failed", "launch_socket_address_in_use", "launch_socket_family_unavailable",
    "launch_socket_creation_failed", "launch_dns_runtime_failed", "launch_security_runtime_failed",
    "launch_ui_runtime_failed",
    "launch_permission_denied",
    "launch_runtime_assertion_failed", "launch_runtime_fatal",
    "launch_process_clean_exit",
    "launch_process_error_exit", "launch_process_signaled", "launch_process_aborted",
